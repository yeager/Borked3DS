...
import io.github.borked3ds.android.databinding.ListItemSettingSwitchBinding
...
import io.github.borked3ds.android.features.settings.ui.viewholder.DateTimeViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.HeaderViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.InputBindingSettingViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.RunnableViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.SettingViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.SingleChoiceViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.SliderViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.StringInputViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.SubmenuViewHolder
import io.github.borked3ds.android.features.settings.ui.viewholder.SwitchSettingViewHolder
import io.github.borked3ds.android.fragments.MessageDialogFragment
import io.github.borked3ds.android.fragments.MotionBottomSheetDialogFragment
...
class SettingsAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SettingViewHolder {
        ...
        return when (viewType) {
            ...
            SettingsItem.TYPE_STRING_INPUT -> {
                ...
                // Fallback to header view holder if the type is unknown
                HeaderViewHolder(ListItemSettingsHeaderBinding.inflate(inflater), this)
            }
        }
    }
    ...
    private fun getItem(position: Int): SettingsItem? {
        return settings?.getOrNull(position)
    }
    ...
    fun onDateTimeClick(item: DateTimeSetting, position: Int) {
        ...
        timePicker.addOnPositiveButtonClickListener {
            val epochTime: Long = (datePicker.selection ?: 0L) / 1000 +
                    timePicker.hour.toLong() * 60 * 60 +
                    timePicker.minute.toLong() * 60
    ...
    fun onSliderClick(item: SliderSetting, position: Int) {
        ...
        dialog = MaterialAlertDialogBuilder(context)
            ...
            .setNeutralButton(R.string.slider_default) { dialog: DialogInterface, _: Int ->
    ...
    private fun getValueForSingleChoiceSelection(item: SingleChoiceSetting, which: Int): Int {
        ...
        return if (valuesId > 0) {
            ...
            valuesArray.getOrNull(which) ?: which
        } else {
            which
        }
    }
    ...
    private fun getSelectionForSingleChoiceValue(item: SingleChoiceSetting): Int {
        ...
        if (valuesId > 0) {
            val valuesArray = context.resources.getIntArray(valuesId)
            valuesArray.forEachIndexed { index, current ->
                if (current == value) {
                    return index
                }
            }
