...
import io.github.borked3ds.android.features.hotkeys.Hotkey
...
class InputBindingSetting(
    ...
    private val context: Context get() = Borked3DSApplication.appContext
    ...
    /**
     * Returns the Borked3DS button code for the settings key.
     */
    ...
    companion object {
        ...
        /**
         * Returns the settings key for the specified Borked3DS button code.
         */
