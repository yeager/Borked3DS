...
object EmulationMenuSettings {
    ...
    var showPerfStatsOverlay: Boolean
        get() = preferences.getBoolean("EmulationMenuSettings_showPerfStatsOverlay", false)
        set(value) {
            preferences.edit()
                .putBoolean("EmulationMenuSettings_showPerfStatsOverlay", value)
                .apply()
        }
