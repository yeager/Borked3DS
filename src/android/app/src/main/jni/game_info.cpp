...
JNIEXPORT jlong JNICALL Java_io_github_borked3ds_android_model_GameInfo_initialize(JNIEnv* env,
                                                                                   jclass,
                                                                                   jstring j_path) {
...
JNIEXPORT void JNICALL Java_io_github_borked3ds_android_model_GameInfo_finalize(JNIEnv* env,
                                                                                jobject obj) {
    delete GetPointer(env, obj);
}

jstring Java_io_github_borked3ds_android_model_GameInfo_getTitle(JNIEnv* env, jobject obj) {
...
jintArray Java_io_github_borked3ds_android_model_GameInfo_getIcon(JNIEnv* env, jobject obj) {
    Loader::SMDH* smdh = GetPointer(env, obj);
...
jboolean Java_io_github_borked3ds_android_model_GameInfo_getIsVisibleSystemTitle(JNIEnv* env,
                                                                                 jobject obj) {
    Loader::SMDH* smdh = GetPointer(env, obj);
    if (smdh == nullptr) {
        return false;
