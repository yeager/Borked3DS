...
static void PrintHelp(const char* argv0) {
    std::cout
        ...
        << " [options] <filename>\n"
           ...
           "--web-api-url       Borked3DS Web API url\n"
           "--ban-list-file     The file for storing the room ban list\n"
           "--log-file          The file for storing the room log\n"
           "--enable-borked3ds-mods Allow Borked3DS Community Moderators to moderate on your room\n"
           "-h, --help          Display this help and exit\n"
           "-v, --version       Output version information and exit\n";
}

static void PrintVersion() {
    std::cout << "Borked3DS dedicated room " << Common::g_scm_branch << " " << Common::g_scm_desc
              << " Libnetwork: " << Network::network_version << std::endl;
}

/// The magic text at the beginning of a borked3ds-room ban list file.
static constexpr char BanListMagic[] = "Borked3DSRoom-BanList-1";
...
int main(int argc, char** argv) {
    ...
    std::string log_file = "borked3ds-room.log";
    ...
    static struct option long_options[] = {
        ...
        {"enable-borked3ds-mods", no_argument, 0, 'e'},
    ...
    if (announce) {
        if (username.empty()) {
            ...
            NetSettings::values.borked3ds_username = UsernameFromDisplayToken(token);
            username = NetSettings::values.borked3ds_username;
            NetSettings::values.borked3ds_token = TokenFromDisplayToken(token);
        } else {
            std::cout << "Hosting a public room\n\n";
            NetSettings::values.web_api_url = web_api_url;
            NetSettings::values.borked3ds_username = username;
...
#else
        std::cout << "Borked3DS Web Services is not available with this build: validation is "
                     "disabled.\n\n";
