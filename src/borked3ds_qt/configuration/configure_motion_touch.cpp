...
#include <QTimer>
#include <QVBoxLayout>
#include "borked3ds_qt/configuration/configure_motion_touch.h"
#include "borked3ds_qt/configuration/configure_touch_from_button.h"
...
bool ConfigureMotionTouch::CanCloseDialog() {
    if (udp_test_in_progress) {
        QMessageBox::warning(this, tr("Borked3DS"),
