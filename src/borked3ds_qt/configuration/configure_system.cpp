...
ConfigureSystem::ConfigureSystem(Core::System& system_, QWidget* parent)
    ...
    if (keys_available) {
        ...
        ui->label_nus_download->setText(
            tr("Borked3DS is missing keys to download system files. <br><a "
               "href='https://web.archive.org/web/20240304203412/https://borked3ds-emu.org/wiki/"
...
void ConfigureSystem::DownloadFromNUS() {
    ...
    if (failed) {
        QMessageBox::critical(this, tr("Borked3DS"), tr("Downloading system files failed."));
