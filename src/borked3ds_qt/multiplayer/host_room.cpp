...
#include "borked3ds_qt/multiplayer/host_room.h"
...
HostRoomWindow::HostRoomWindow(Core::System& system_, QWidget* parent, QStandardItemModel* list,
    ...
    if (ui->username->text().isEmpty() && !NetSettings::values.borked3ds_username.empty()) {
        // Use Borked3DS Web Service user name as nickname by default
        ui->username->setText(QString::fromStdString(NetSettings::values.borked3ds_username));
    }
                ...
                if (result.result_code != Common::WebResult::Code::Success) {
                    QMessageBox::warning(
                        ...
                        tr("Failed to announce the room to the public lobby. In order to host a "
                           "room publicly, you must have a valid Borked3DS account configured in "
