...
void RO::LoadCRO(Kernel::HLERequestContext& ctx, bool link_on_load_bug_fix) {
    ...
    if (cro_buffer_ptr & Memory::BORKED3DS_PAGE_MASK) {
    ...
    if (cro_address & Memory::BORKED3DS_PAGE_MASK) {
    ...
    if (cro_size & Memory::BORKED3DS_PAGE_MASK) {
