...
ResultVal<VMManager::VMAIter> VMManager::CarveVMA(VAddr base, u32 size) {
    ASSERT_MSG((size & Memory::BORKED3DS_PAGE_MASK) == 0, "non-page aligned size: {:#10X}", size);
    ASSERT_MSG((base & Memory::BORKED3DS_PAGE_MASK) == 0, "non-page aligned base: {:#010X}", base);
...
ResultVal<VMManager::VMAIter> VMManager::CarveVMARange(VAddr target, u32 size) {
    ASSERT_MSG((size & Memory::BORKED3DS_PAGE_MASK) == 0, "non-page aligned size: {:#10X}", size);
    ASSERT_MSG((target & Memory::BORKED3DS_PAGE_MASK) == 0, "non-page aligned base: {:#010X}",
               target);
