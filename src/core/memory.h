 ...
 * be mapped.
 */
constexpr u32 BORKED3DS_PAGE_SIZE = 0x1000;
constexpr u32 BORKED3DS_PAGE_MASK = BORKED3DS_PAGE_SIZE - 1;
constexpr int BORKED3DS_PAGE_BITS = 12;
constexpr std::size_t PAGE_TABLE_NUM_ENTRIES = 1 << (32 - BORKED3DS_PAGE_BITS);
