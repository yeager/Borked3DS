...
ResultStatus Apploader_Artic::LoadExec(std::shared_ptr<Kernel::Process>& process) {
    ...
    if (ResultStatus::Success == ReadCode(code) &&
        ...
        codeset->CodeSegment().size =
            program_exheader.codeset_info.text.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
        ...
        codeset->RODataSegment().size =
            program_exheader.codeset_info.ro.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
        ...
        codeset->DataSegment().size =
            program_exheader.codeset_info.data.num_max_pages * Memory::BORKED3DS_PAGE_SIZE +
            bss_page_size;
...
ResultStatus Apploader_Artic::ReadCode(std::vector<u8>& buffer) {
    ...
    size_t code_size =
        program_exheader.codeset_info.text.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
    code_size += program_exheader.codeset_info.ro.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
    code_size += program_exheader.codeset_info.data.num_max_pages * Memory::BORKED3DS_PAGE_SIZE;
