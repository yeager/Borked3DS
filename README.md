...
That said, this fork will still work with Bravely Offline. Just rename the `borked3ds.exe` executable to `citra.exe` and copy/paste the entire bundle into the relevant Citra directory in Bravely Offline like before and run the client/server program normally. Alternatively, you can find the last version of Bravely Offline Citra [here](https://github.com/Borked3DS/Borked3DS/releases/tag/v2024.10.29a).
